...
int main(int argc, char **argv)
{
	...
	// eventAttrib will be used to mark a range of host code
	...
	// To profile and visualize host memory allocation
    eventAttrib.color = RED;
    eventAttrib.message.ascii = "HostMalloc";
    nvtxRangeId_t hostMalloc = nvtxRangeStartEx(&eventAttrib);	// range start
    ...
    nvtxRangeEnd(hostMalloc);	// range end
